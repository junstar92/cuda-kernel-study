...
#include "07_warptiling_vec4.cuh"
...
PYBIND11_MODULE(TORCH_EXTENSION_NAME, m) {
  ...
  bind_sgemm<&sgemm::warptiling::launch<128, 128, 8, 32, 64, 8>>(
      m, "sgemm_warptiling_128x128x8_32x64x8");
  bind_sgemm<&sgemm::warptiling::launch<128, 128, 8, 64, 32, 8>>(
      m, "sgemm_warptiling_128x128x8_64x32x8");
  bind_sgemm<&sgemm::warptiling_vec4::launch<128, 128, 8, 32, 64, 8>>(
      m, "sgemm_warptiling_vec4_128x128x8_32x64x8");
  bind_sgemm<&sgemm::warptiling_vec4::launch<128, 128, 8, 64, 32, 8>>(
      m, "sgemm_warptiling_vec4_128x128x8_64x32x8");
}
