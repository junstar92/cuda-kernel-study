...
__DEVICE__ void epilogue(float* c_ptr,
  ...
  utils::EpilogueSharedLoadIterator<Traits> shared_load_iter(
      smem, tid, Traits::kEpilogueStride);
  utils::EpilogueOutputStoreIterator<Traits> out_iter(c_ptr, tid, ldc);

  typename utils::AccumulatorFragmentIterator<Traits>::Fragment accum_frag;
  typename utils::EpilogueOutputStoreIterator<Traits>::Fragment output_frag;
